...
import ActionTooltip from '@/components/shared/ActionTooltip.vue';
import ConfirmDialog from '@/components/shared/ConfirmDialog.vue';
import DataTable from '@/components/shared/DataTable.vue';
import EmptyState from '@/components/shared/EmptyState.vue';
import FiltersBar from '@/components/shared/FiltersBar.vue';
import IconAction from '@/components/shared/IconAction.vue';
...
<template>
    <AdminLayout title="Usuarios">
            ...
            <FiltersBar>
                ...
                <template #right>
                    <button
                        v-if="isFiltering"
                        type="button"
                        class="h-10 rounded-md border px-3 text-sm hover:bg-accent"
                        @click="clear"
                    >
                        Limpiar
                    </button>
        ...
        <ConfirmDialog
            ...
            description="Esta acción enviará el usuario a la papelera."
